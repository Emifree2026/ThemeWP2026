...
if ( ! $emifree_current_post ) {
	...
	<div class="min-h-screen bg-white">
		<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
			...
			<a href="/de/blog" class="inline-flex items-center gap-2 text-blue-700 hover:text-blue-800 font-medium">
...
<div class="min-h-screen bg-white">
	...
	<div class="bg-slate-50 border-b border-slate-200">
		<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
			...
			<nav aria-label="Brotkrumen" class="mb-6 text-sm text-zinc-500">
				<a href="/de" class="hover:text-blue-700">Startseite</a>
				<span class="mx-2" aria-hidden="true">/</span>
				<a href="/de/blog" class="hover:text-blue-700">Blog</a>
				<span class="mx-2" aria-hidden="true">/</span>
	...
	<article class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12" itemscope itemtype="https://schema.org/BlogPosting">
		...
		<link itemprop="url" href="<?php echo esc_url( EMIFREE_SITE_URL . '/de/blog/' . $emifree_current_post['slug'] ); ?>">
		...
		<div class="mt-16 pt-8 border-t border-slate-200">
			<div class="flex items-center justify-between mb-8">
				<a href="/de/blog" class="inline-flex items-center gap-2 text-blue-700 hover:text-blue-800 font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded">
					<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" aria-hidden="true">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5"></path>
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 19-7-7 7-7"></path>
					</svg>
			...
			<?php if ( $emifree_next_post ) : ?>
				<a href="/de/blog/<?php echo esc_attr( $emifree_next_post['slug'] ); ?>/" class="group block bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-200 rounded-2xl p-6 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
